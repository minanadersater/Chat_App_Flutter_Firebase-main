...
import 'package:chat_app/group_chats/sub_group/add_members.dart';
...
class SubGroupInfo extends StatefulWidget {
  final String groupId, groupName,subgroupId;
  const SubGroupInfo({required this.groupId, required this.groupName, Key? key, required this.subgroupId})
      : super(key: key);
                            ...
                            onTap: () => Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (_) => AddMembersINSubGroup(
                                  ...
                                  membersList: membersList, subgroupId: widget.subgroupId,
                                ),
                              ),
                            ),
                            leading: Icon(
